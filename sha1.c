...
/* 
 * Code has been stripped down to a single .c file so it can be used 
 * as a freestanding include, rol define taken from bithelp.h and
 * wipememory define taken from util.h, all from GnuPG 1.4.19
 */
